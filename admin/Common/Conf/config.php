...
$config = array(
	...
	*/
    ...
    //需要做产品模块化的项(56=>校园科技节,60=>课后一小时)
    'ARR_PRODUCT'   => array(56,60),

    //获取IP,论坛输入限制
    'ARR_IP'        => array('127.0.0.1','124.16.248.193','124.16.248.194','124.16.248.195','124.16.248.196','124.16.248.197','124.16.248.198','124.16.248.199','124.16.248.200','124.16.248.201','124.16.248.202','124.16.248.203','124.16.248.204','124.16.248.205',
        '124.16.248.206','124.16.248.207','124.16.248.208','124.16.248.209','124.16.248.210', '124.16.248.211','124.16.248.212','124.16.248.213','124.16.248.214','124.16.248.215','124.16.248.216', '124.16.248.217','124.16.248.218','124.16.248.219',
        '124.16.248.220','124.16.248.221','124.16.248.222','111.196.66.142','114.254.59.121','49.77.189.170','27.17.222.120','175.168.190.146','223.99.20.87','36.104.40.146','125.34.49.57'),
    //'49.77.189.170(南京),27.17.222.120(武汉),'175.168.190.146(沈阳),'223.99.20.87(济南)','36.104.40.146(长春)'
    ...
    //'NOT_USE_OTHER_EXPENSES'=>array(12,15,16,17,18,19,21), //其他费用中未使用到的 BXD_KIND, 排除工资,社保,公积金等
    ...
    //每个人的应评分人员(内部人员满意度)
    'SATISFACTION_USER'=>array(
        '55'        => '13,39,12,26,204,77,114', //程小平
        '13'        => '55,39,12,26,204,77,114', //杜莹
        '39'        => '13,55,12,26,204,77,114', //孟华
        '12'        => '13,39,55,26,204,77,114', //秦鸣
        '26'        => '13,39,12,55,204,77,114', //李岩
        '204'       => '13,39,12,26,55,77,114', //李徵红
        '77'        => '13,39,12,26,204,55,114', //王茜
        '114'       => '13,39,12,26,204,77,55', //王丹
        '31'        => '', //魏春竹
    ),
