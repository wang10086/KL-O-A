...
/*	
	...
	*/
    ...
    public function kpi_quota(){
		...
		if($auto==1){
			$where['id'] = array('not in',array(1,2,3,4,5,6,81,8,9,10,11,15,16,18,20,23,26,21,24,27,32,37,19,22,25,28,33,38,42,45,103,56,113,92,29,34,39,46,102,55,57,58,59,84,87,89,90,111,107,83,66,54,44,12,112,108,100,96,95,65,114,86,85,64,63,62,53,52,41,40));
		}else if($auto==2){
			$where['id'] = array('in',array(91,47,36,35,31,30));
		}
