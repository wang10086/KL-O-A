...
class ExportController extends BaseController {
	...
	public function chart_finance(){
		...
		$expdata  = array();
		$datalist = $db->table('__OP_SETTLEMENT__ as b')->field('b.*,o.project,o.group_id,o.number,o.customer,o.create_user_name,o.destination,o.days,o.remark')->join('__OP__ as o on b.op_id = o.op_id','LEFT')->where($where)->order('b.create_time DESC')->select();
		foreach($datalist as $k=>$v){
