                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form role="form" method="post" action="{:U('SupplierRes/addreskind')}" name="myform" id="myform">
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                        ...
                                        <input type="hidden" name="info[type]" value="<?php echo Sys\P::RES_TYPE_SUPPLIER; ?>" />
