            ...
            <div class="form-group col-md-12" style="align: center;">
                <table style="width: 100%; margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td colspan="5" class="td_con td">
                            <div class="form-group col-md-12">
                                <textarea class="form-control no-border-textarea" value="{$resource['act_back_need']}"  name="info[act_back_need]" readonly>{$resource['act_back_need']}</textarea>
                            </div>
                        </td>
                    </tr>
                </table>
