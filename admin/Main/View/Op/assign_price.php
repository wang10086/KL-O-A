...
<html>
    ...
    <body>
        ...
        <section class="content">
        	<div id="selectbox">
            <form action="{:U('Op/assign_price')}" method="get" id="feedbackform">
            <input type="hidden" name="m" value="Main">
            <input type="hidden" name="c" value="Op">
            <input type="hidden" name="a" value="assign_price">
            ...
            <form method="post" action="{:U('Op/assign_price')}" name="myform" id="gosub">
