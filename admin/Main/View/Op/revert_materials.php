            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{:U('Op/revert_materials')}"><i class="fa fa-gift"></i> 项目预算</a></li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                        	 ...
                        	 <div class="btn-group" id="catfont">
                                ...
                                <if condition="rolemenu(array('Op/revert_materials'))"><a href="{:U('Op/revert_materials',array('opid'=>$op['op_id']))}" class="btn btn-info">归还物资</a></if>
                                <!-- 
                            ...
                            <php> if($budget['audit_status']==1 && $op['status']==1 && $op['group_id']){ </php>
                                ...
                                <div class="box-body">
                                    <div class="content" style="padding-bottom:50px;">
                                        ...
                                        <div id="formsbtn" style="padding-bottom:10px; padding-top:20px;">
                                            <button class="btn btn-info btn-lg" onClick="appmateials();" id="lrpd">立即申请所需物资</button>
                                        </div>
