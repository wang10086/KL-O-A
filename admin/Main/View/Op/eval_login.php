...
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title><?php echo P::SYSTEM_NAME; ?>登录反馈</title>
    ...
    <span id="a"></span>
        <div class="form-box" id="mob-registe-box">
            ...
            <form method="post" action="{:U('Op/public_eval_login')}" name="myform" id="myform">
        ...
        $(function(){
            $("#myform").Validform({
                ...
                callback:function(data){
                    ...
                    if(obj.status == 'y'){
                        showmsg('提示', obj.info);
                        setTimeout("window.location.href='/index.php?m=Main&c=Op&a=public_eval_score&opid='+opid",1500);
                    }else{
                        showmsg('提示',obj.info);
                    }
                }
