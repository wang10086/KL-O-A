                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form method="post" action="{:U('Material/purchase')}" name="myform" id="myform">
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">物资采购申请</h3>
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <foreach name="rolelist"  item="v">
                                                <option value="{$v.id}" <?php if ($row && ($v['id'] == $row['department'])) echo ' selected'; ?> >{$v.role_name}</option>
                                            </foreach>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <label>项目立项人</label>
                                            <input type="text" name="info[op_user]" id="op_user" value="{$row.op_user}"  class="form-control" />
                                        </div>
                            ...
                            <div id="formsbtn">
                            	<button type="button" class="btn btn-success btn-lg" id="lrpd" onClick="onsubmint()">申请采购</button>
                            </div>
