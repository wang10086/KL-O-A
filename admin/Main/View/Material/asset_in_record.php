<include file="Index:header2" />
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right box-tools">
                                        ...
                                        <button onClick="javascript:window.location.href='{:U('Material/asset_in',array('id'=>$material_id))}';" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> 资产入库</button>
                                        </if>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">
        ...
        <div id="searchtext">
            ...
            <input type="hidden" name="a" value="asset_in_record">
            <div class="form-group col-md-6">
                <select  class="form-control"  name="material">
                    <option value="">物资名称</option>
                    <foreach name="material"  item="v">
                        <option value="{$v.id}" <?php if ($row && ($v['id'] == $row['material_id'])) echo ' selected'; ?> >{$v.material}</option>
                    </foreach>
                </select>
            </div>
            <div class="form-group col-md-6">
