                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="form-group col-md-4 viwe">
                                            <p>入库类型： <?php echo $leixing[$row['type']];  ?></p>
                                        </div>
                                        
                                        <div class="form-group col-md-4 viwe">
                                            <p>入库部门： <?php echo $bumen[$row['department']];  ?></p>
                                        </div>
                                        
                                        <div class="form-group col-md-4 viwe">
                                            <p>入库申请人：{$row.purchase_liable} </p>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <p>计调负责人:{$row.op_liable}</p>
                                        </div>
                                      	
                                        <div class="form-group col-md-4 viwe">
                                            <p>申请时间：<?php echo date('Y-m-d H:i:s',$row['into_time']) ?></p>
                                        </div>
