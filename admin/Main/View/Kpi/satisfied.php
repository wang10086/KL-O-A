<include file="Index:header2" />
                        ...
                        <div class="col-xs-12">
                            <div class="box box-success">
                                ...
                                <table class="table table-bordered dataTable fontmini" id="tablelist" style="margin-top:10px;">
                                    ...
                                    <tr class="black">
                                        <td colspan="1">项目总数：{$data.shishi_num}</td>
                                        <td colspan="2">已调查项目数/项目总数：<?php echo $data['score_num'].'/'.$data['shishi_num']; ?></td>
                                        <td colspan="3">已调查顾客满意度：{$data.score_average}</td>
                                        <if condition="$uid eq 59">
                                        <td class="taskOptions">{$data.customerServiceAverage}</td>
                                        </if>
                                        <td colspan="3">总顾客满意度：{$data.complete}</td>
                                    </tr>
                                </table>
                                </div><!-- /.box-body -->
            ...
            <div id="searchtext">
                ...
                <input type="hidden" name="a" value="public_satisfied">
