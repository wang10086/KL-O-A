                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($row['kpi_cycle']==1){ ?>     <!--月度-->
                                                    <td class="taskOptions"><a href="{:U('Kpi/kpiinfo',array('year'=>$year,'month'=>'01','uid'=>$row['id']))}" target="_blank" <?php if ((($year-1 == date('Y') && date('md')>1225) || ($year == date('Y') && date('md')<0126))){echo "class=red"; }; ?>><?php echo (time()>strtotime(($year-1).'1226') && $row['kpi']['01'] !== null)?$row["kpi"]['01']:'<font color="#999999">未考核</font>';  ?></a></td>
