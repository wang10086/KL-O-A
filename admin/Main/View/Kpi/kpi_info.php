                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php }elseif ($encourage_type == 5){ ?>
                                <include file="kpi_encourage_5" />
                            <?php }elseif ($encourage_type == 6){ ?>
                                <include file="kpi_encourage_6" />
                            <?php }elseif ($encourage_type == 7){ ?>
                                <include file="kpi_encourage_7" />
                            <?php }elseif ($encourage_type == 8){ ?>
                            ...
                            <?php }elseif ($encourage_type == 11){ ?>
                                <include file="kpi_encourage_11" />
                            <?php }elseif ($encourage_type == 12){ ?>
