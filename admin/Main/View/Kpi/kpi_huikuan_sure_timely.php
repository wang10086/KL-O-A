                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title pull-right" style="font-weight:normal; color:#333333;">月份：{$month} &emsp;</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <div class="form-group col-md-12 black">
                                        <p style="width: 33%; display: inline-block;">总数：{$data.sum_num}</p>
                                        <p style="width: 33%; display: inline-block;">及时：{$data.ok_num}</p>
                                        <p style="width: 33%; display: inline-block;">及时率：{$data.average}</p>
                                    </div>
                                    ...
                                    <table class="table table-bordered dataTable fontmini" id="tablelist" style="margin-top:10px;">
                                        ...
                                        <foreach name="lists" key="k" item="v">
                                            <tr>
                                                ...
                                                <td class="taskOptions">{$v.req_time|date="Y-m-d H:i",###}</td>
