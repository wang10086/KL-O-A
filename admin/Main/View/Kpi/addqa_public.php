<include file="Index:header2" />
            ...
            <aside class="right-side">
                ...
                <form method="post" action="{:U('Kpi/public_addqa')}" name="myform" id="myform">
                                ...
                                <div class="box-body">
                                    <div class="content">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>巡检日期：</label><input type="text" name="info[ins_date]" class="form-control inputdate"  value="<?php if($row['ins_date']){ echo date('Y-m-d',$row['ins_date']);} ?>" required />
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>问题描述：</label>
                                            <textarea name="info[content]"  class="form-control" style="height:100px;" required>{$row.content}</textarea>
                                        </div>
