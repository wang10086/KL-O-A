<include file="Index:header_art" />
    ...
    <div class="box-body art_box-body">
        ...
        <div class="fromlist fromlistbrbr"  style=" padding:15px 0 0 0;">
            <?php if (in_array($opid,$dijie_opids)){ ?>
                <div class="form-group box-float-4" style="padding-left:0;">客户沟通：{$score_stu.$row[before_sell]}</div>
                <div class="form-group box-float-4" style="padding-left:0;">产品培训：{$score_stu.$row[new_media]}</div>
                ...
                <div class="form-group box-float-4" style="padding-left:0;">中科院资源：{$score_stu.$row[cas_time]}</div>
                <div class="form-group box-float-4" style="padding-left:0;">常规资源：{$score_stu.$row[travel]}</div>
                <div class="form-group box-float-4" style="padding-left:0;">活动实施：{$score_stu.$row[major]}</div>
                <div class="form-group box-float-4" style="padding-left:0;">辅导员：{$score_stu.$row[guide]}</div>
                <div class="form-group box-float-4" style="padding-left:0;">持续合作：{$score_stu.$row[material]}</div>
            <?php }else{ ?>
                <?php if ($kind==2){ ?>
