                        ...
                        <div class="col-xs-12">
                            <div class="btn-group" id="catfont" style="padding-bottom:20px;">
                                <?php if($prveyear>2017){ ?>
                                    <a href="{:U('Contract/public_quarter_detail',array('year'=>$prveyear,'quarter'=>$quarter,'month'=>'01','uid'=>$uid))}" class="btn btn-default" style="padding:8px 18px;">上一年</a>
                                <?php } ?>
                                <?php
                                    for($i=1;$i<5;$i++){
                                        $par          = array();
                                        ...
                                        $par['uid']   = $uid;
                                        if($quarter==$i){
                                            echo '<a href="'.U('Contract/public_quarter_detail',$par).'" class="btn btn-info" style="padding:8px 18px;">'.$i.'季度</a>';
                                        }else{
                                            echo '<a href="'.U('Contract/public_quarter_detail',$par).'" class="btn btn-default" style="padding:8px 18px;">'.$i.'季度</a>';
                                        }
                                    }
                                ?>
                                <?php if($year<date('Y')){ ?>
                                    <a href="{:U('Contract/public_quarter_detail',array('year'=>$nextyear,'quarter'=>$quarter,'month'=>'01','uid'=>$uid))}" class="btn btn-default" style="padding:8px 18px;">下一年</a>
                                <?php } ?>
                            </div>
