                                ...
                                <div class="content">
                                    <?php for ($i=1; $i<7; $i++){ ?>
                                        <div class="form-group col-md-3 viwe" style="display: inline-block;">
                                            ...
                                            <!--<p><i class="fa fa-caret-right"></i><a href="javascript:;" title="新建">AAAAAAAAAAAAAA</a></P>
                                            <p><i class="fa fa-caret-right"></i><a href="javascript:;" title="新建">BBBBBBBBBBBBBB</a></P>
                                            <p><i class="fa fa-caret-right"></i><a href="javascript:;" title="新建">CCCCCCCCCCCCCC</a></P>
                                            <p><i class="fa fa-caret-right"></i><a href="javascript:;" title="新建">DDDDDDDDDDDDDDDDDD</a></P>
                                            <p><i class="fa fa-caret-right"></i><a href="javascript:;" title="新建">EEEEEEEEEEEEE测试测试测试测试</a></P>-->
                                        </div>
                                    <?php } ?>
