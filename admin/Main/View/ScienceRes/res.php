                                ...
                                <div class="box-body">
                                	...
                                	<table class="table table-bordered dataTable fontmini" id="tablelist">
                                        <tr role="row" class="orders" >
                                            ...
                                            <!--
                                            <th class="sorting" data="sales_price">销售价</th>
                                            ...
                                            <if condition="rolemenu(array('ScienceRes/delres'))">
                                        ...
                                        <tr>
                                            ...
                                            <button onClick="javascript:window.location.href='{:U('ScienceRes/addres',array('id'=>$row['id']))}';" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></button>
                                            ...
                                            <if condition="rolemenu(array('ScienceRes/delres'))">
                                            <td class="taskOptions">
                                            <button onClick="javascript:ConfirmDel('{:U('ScienceRes/delres',array('id'=>$row['id']))}')" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></button>
                                            </td>
                                            </if>
                                        </tr>
                                        </foreach>		
