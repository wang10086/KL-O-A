                                ...
                                <div style="width:96%;margin-left:2em;">
                                    <div style="float:left;width:68%;overflow-y:scroll;overflow-y:visible;">
                                        ...
                                        <div style="height:90em;overflow: hidden;border-top:solid 2px #d2d5d8;">
                                             <iframe src="https://view.officeapps.live.com/op/view.aspx?src={$sercer}<?php if(!empty($approval['Approval_url']['modify_url'])){echo $approval['Approval_url']['modify_url'];}else{echo $approval['Approval']['file_url'];}?>" style="overflow-y:scroll;overflow-x:scroll;word-wrap:break-word;width:100%;height:100%;overflow-x:hidden;margin-top:-6em;">
                                            </iframe>
                                        </div>
                                    </div>
