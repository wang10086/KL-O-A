                                ...
                                <div class="box-body">
                                    <table class="table table-bordered dataTable fontmini" id="tablelist">
                                        <tr role="row" class="orders" >
                                            <th class="sorting" data="id">企业编号</th>
                                            <th class="sorting" data="company_name">企业名称</th>
                                        ...
                                        <tr>
                                            ...
                                            <button onClick="javascript:window.location.href='{:U('User/dealer_edit',array('id'=>$row['id']))}';" title="修改资料" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></button>
                                            </td>
                                            </if>
                                            <if condition="rolemenu('Delete/company')">
                                            <td class="taskOptions">
                                            <button onClick="javascript:ConfirmDel('{:U('Delete/company',array('id'=>$row['id']))}');" title="删除用户" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></button>
                                            </td>
                                        	 </if>
                                        </tr>
                                        </foreach>		
