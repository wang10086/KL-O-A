                                ...
                                <table class="table table-bordered dataTable fontmini" id="tablelist">
                                    ...
                                    <foreach name="roles" item="row">
                                        <tr>
                                            ...
                                            <a href="javascript:;" onClick="op_pdca_auth({$row.id})" title="设置" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                            </td>
                                            </if>
                                        </tr>
                                    </foreach>										
...
<include file="Index:footer2" />
	<script>
    //编辑PDCA项目
	function op_pdca_auth(id) {
		var pdcaid = '{$pdca.id}';
		art.dialog.open('index.php?m=Main&c=Rbac&a=op_pdca_auth&id='+id,{
			lock:true,
			title: '指定部门PDCA评分人',
			width:800,
			height:400,
