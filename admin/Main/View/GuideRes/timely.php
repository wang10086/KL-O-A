                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="btn-group" id="catfont" style="padding-bottom:20px;">
                                <?php if($prveyear>2017){ ?>
                                    <a href="{:U('GuideRes/timely',array('year'=>$prveyear,'month'=>'01'))}" class="btn btn-default" style="padding:8px 18px;">上一年</a>
                                <?php } ?>
                                <?php
                                    for($i=1;$i<13;$i++){
                                        $par            = array();
                                        ...
                                        if($month==$i){
                                            echo '<a href="'.U('GuideRes/timely',$par).'" class="btn btn-info" style="padding:8px 18px;">'.$i.'月</a>';
                                        }else{
                                            echo '<a href="'.U('GuideRes/timely',$par).'" class="btn btn-default" style="padding:8px 18px;">'.$i.'月</a>';
                                        }
                                    }
                                ?>
                                <?php if($year<date('Y')){ ?>
                                    <a href="{:U('GuideRes/timely',array('year'=>$nextyear,'month'=>'01'))}" class="btn btn-default" style="padding:8px 18px;">下一年</a>
                                <?php } ?>
                            </div>
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                        <if condition="rolemenu(array('GuideRes/timely_list'))">
                                            <a href="{:U('GuideRes/timely_list')}" class="btn btn-info btn-sm">考核指标管理</a>
                                        </if>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <foreach name="lists" key="k" item="v">
                                            <tr>
                                                ...
                                                <td class="taskOptions">
                                                    <!--<a href="{:U('GuideRes/public_timely_detail',array('tit'=>$v['title'],'year'=>$year,'month'=>$month))}" title="详情" class="btn btn-info btn-smsm"><i class="fa fa-bars"></i></a>-->
