                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                         ...
                                         <a href="javascript:;" onClick="javascript:{:open_price()}" class="btn btn-sm btn-danger"><i class="fa fa-plus"></i> 新建资源</a>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                	<table class="table table-bordered dataTable fontmini" id="tablelist">
                                        <tr role="row" class="orders" >
                                            ...
                                            <th class="sorting" data="kname">类型</th>
                                        ...
                                        <tr>
                                            ...
                                            <if condition="rolemenu(array('GuideRes/addprice'))">
                                                <td class="taskOptions">
                                                    <a href="javascript:;" onClick="javascript:{:open_price($row['id'])}" ><button onClick="javascript:;" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></button></a>
                                                </td>
                                            </if>
                                            <if condition="rolemenu(array('GuideRes/del_price'))">
                                                <td class="taskOptions">
                                                    <button onClick="javascript:ConfirmDel('{:U('GuideRes/del_price',array('id'=>$row['id']))}')" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></button>
                                                </td>
                                            </if>
                                        </tr>
                                        </foreach>		
