                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                         <a href="{:U('GuideRes/addreskind')}" class="btn btn-sm btn-danger"><i class="fa fa-plus"></i> 添加分类</a>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">
<table class="table table-bordered dataTable fontmini" id="tablelist">
                ...
                <th>ID</th>
                <th>名称</th>
                <if condition="rolemenu(array('GuideRes/addreskind'))">
        ...
        <foreach name="lists" item="row">
            <tr>
                ...
                <button onClick="javascript:window.location.href='{:U('GuideRes/addreskind',array('id'=>$row['id']))}';" title="修改" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></button>
