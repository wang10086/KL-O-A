                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="btn-group" id="catfont">
                                    ...
                                    <a href="{:U('Worder/worder_list',array('pin'=>101))}" class="btn <?php if($pin==101){ echo 'btn-info';}else{ echo 'btn-default';} ?>">我的已指派项目工单</a>
                                    <a href="{:U('Worder/worder_list',array('pin'=>102))}" class="btn <?php if($pin==102){ echo 'btn-info';}else{ echo 'btn-default';} ?>">我的待执行项目工单</a>
                                </div>
