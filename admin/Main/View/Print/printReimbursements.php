                ...
                <div class="one-third-a4">
                    <table class="bxd-table" style="width: 99%;">
                        ...
                        <?php if ($v[0]['bxd_type']==1){ ?>
                            ...
                            <tr>
                                <td colspan="2" class="td">&emsp;证明验收人签字：<span id="zmysr"> <?php if($v[0]['zm_audit_status']==2){echo "<span class='red'>不通过</span>"; }elseif ($v[0]['zm_audit_status']==1){ echo "<img src='/".$v[0]['zm_audit_file']."' height='50px'>";}; ?></span></td>
                    ...
                    <div class="one-third-a4">
                        <table class="bxd-table" style="width: 99%;">
                            ...
                            <?php if ($v[1]['bxd_type']==1){ ?>
                                ...
                                <tr>
                                    <td colspan="2" class="td">&emsp;证明验收人签字：<span id="zmysr"> <?php if($v[1]['zm_audit_status']==2){echo "<span class='red'>不通过</span>"; }elseif ($v[1]['zm_audit_status']==1){ echo "<img src='/".$v[1]['zm_audit_file']."' height='50px'>";}; ?></span></td>
                    ...
                    <div class="one-third-a4">
                        <table class="bxd-table" style="width: 99%;">
                            ...
                            <?php if ($v[2]['bxd_type']==1){ ?>
                                ...
                                <tr>
                                    <td colspan="2" class="td">&emsp;证明验收人签字：<span id="zmysr"> <?php if($v[2]['zm_audit_status']==2){echo "<span class='red'>不通过</span>"; }elseif ($v[2]['zm_audit_status']==1){ echo "<img src='/".$v[2]['zm_audit_file']."' height='50px'>";}; ?></span></td>
