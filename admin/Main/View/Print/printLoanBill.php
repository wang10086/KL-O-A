            ...
            <div class="page-tables">
                <table class="jkd-table" style="width: 99%;">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="td">&emsp;&yen;&emsp;<input type="text" style="border:none;border-bottom: solid 1px #808080; " value="{$v.sum}">元</td>
                    </tr>
                    <tr>
...
<script>
    ...
    function print_A4_view(id){
        $('.jkd-table').css({'width': '90%','margin': '20px 5%','height': '550px'});
