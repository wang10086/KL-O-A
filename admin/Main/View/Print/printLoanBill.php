                    ...
                    <table class="jkd-table" style="width: 99%;">
                        <tr>
                            <td  colspan="6" style="text-align: center;">
                                <b style="font-weight: 600;font-size: large;">{$company[$v[0]['company']]}借款单</b>
                            </td>
                        </tr>
                        <tr>
                            <td  colspan="6">
                        ...
                        <?php if ($v[0]['jkd_type']!=2){ ?>
                            <!--团内支出借款-->
                            <tr>
                                <td class="td" colspan="2">&emsp;团号：<span class="black">{$v[0]['group_id']}</span></td>
                        ...
                        <tr>
                            <td colspan="5" class="td">&emsp;借款金额：{$v[0].sum_chinese}</td>
                ...
                <if condition="$v[1]">
                    <div class="one-third-a4">
                        <table class="jkd-table" style="width: 99%;">
                            <tr>
                                <td  colspan="6" style="text-align: center;">
                                    <b style="font-weight: 600;font-size: large;">{$company[$v[1]['company']]}借款单</b>
                                </td>
                            </tr>
                            <tr>
                                <td  colspan="6">
                            ...
                            <?php if ($v[1]['jkd_type']!=2){ ?>
                                <!--团内支出借款-->
                                <tr>
                                    <td class="td" colspan="2">&emsp;团号：<span class="black">{$v[1]['group_id']}</span></td>
                            ...
                            <tr>
                                <td colspan="5" class="td">&emsp;借款金额：{$v[1].sum_chinese}</td>
                ...
                <if condition="$v[2]">
                    <div class="one-third-a4">
                        <table class="jkd-table" style="width: 99%;">
                            <tr>
                                <td  colspan="6" style="text-align: center;">
                                    <b style="font-weight: 600;font-size: large;">{$company[$v[2]['company']]}借款单</b>
                                </td>
                            </tr>
                            <tr>
                                <td  colspan="6">
                            ...
                            <?php if ($v[2]['jkd_type']!=2){ ?>
                                <!--团内支出借款-->
                                <tr>
                                    <td class="td" colspan="2">&emsp;团号：<span class="black">{$v[2]['group_id']}</span></td>
                            ...
                            <tr>
                                <td colspan="5" class="td">&emsp;借款金额：{$v[2].sum_chinese}</td>
