...
<html>
    ...
    <body>
        ...
        <section class="content">
        	<div id="selectbox">
            <form action="{:U('Customer/o2o_apply')}" method="get" id="feedbackform">
            <input type="hidden" name="m" value="Main">
            <input type="hidden" name="c" value="Customer">
            <input type="hidden" name="a" value="o2o_apply">
            ...
            <form method="post" action="{:U('Customer/o2o_apply')}" name="myform" id="gosub">
