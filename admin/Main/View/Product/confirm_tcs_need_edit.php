...
<!--<form method="post" action="{:U('Product/public_save')}" id="tcs_need_form" onsubmit="return submitBefore()">-->
<form method="post" action="{:U('Product/public_save')}" id="tcs_need_form">
                                    ...
                                    <?php if($guide_need){ ?>
                                        <foreach name="guide_need" key="k" item="v">
                                            <div class="userlist no-border" id="tcs_id_{$v.id}">
                                                ...
                                                <select  class="form-control" style="width:22%"  name="data[{$k}][field]">
                                                ...
                                                <input type="text" class="form-control" style="width:28%" name="data[{$k}][remark]" value="{$v.remark}">
