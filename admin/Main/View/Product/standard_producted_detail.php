            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{:U('Project/index')}"><i class="fa fa-gift"></i> 标准化产品</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title">标准产品介绍</h3>
                                    <h3 class="box-title pull-right" style="font-weight:normal; color:#333333; margin-right: 20px;">研发专家：{$row.input_uname}</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
