        ...
        <div class="content">
            ...
            <form method="post" action="{:U('Product/public_save_customer_need')}" name="myform" id="detailForm">
                ...
                <div class="form-group col-md-4">
                    <label>培训时间：</label><input type="text" name="in_time"  value="<?php echo $need['st_time'] ? date('Y-m-d',$need['st_time']).' - '.date('Y-m-d',$need['et_time']) : ($detail['st_time'] ? date('Y-m-d',$detail['st_time']).' - '.date('Y-m-d',$detail['et_time']) : ''); ?>" class="form-control between_day"  required />
                </div>

                <div class="form-group col-md-4">
                    <label>培训预算(元/人)：</label>
                    <input type="text" class="form-control" name="data[price]" value="{$need ? $need['price'] : $detail['price']}" />
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 50%; float: left;">
                        院所名称：<input type="text" name="data[ins_name]" value="{$need ? $need['ins_name'] : $detail['ins_name']}" style="border: none; border-bottom: solid 1px; min-width: 200px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 50%; float: left;">
                        企业名称：<input type="text" name="data[company_name]" value="{$need ? $need['company_name'] : $detail['company_name']}" style="border: none; border-bottom: solid 1px; min-width: 200px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 50%; float: left;">
                        高校名称：<input type="text" name="data[school_name]" value="{$need ? $need['school_name'] : $detail['school_name']}" style="border: none; border-bottom: solid 1px; min-width: 200px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 50%; float: left;">
                        景点名称：<input type="text" name="data[scenicSpot_name]" value="{$need ? $need['scenicSpot_name'] : $detail['scenicSpot_name']}" style="border: none; border-bottom: solid 1px; min-width: 200px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 50%; float: left;">
                        博物馆名称：<input type="text" name="data[museum_name]" value="{$need ? $need['museum_name'] : $detail['museum_name']}" style="border: none; border-bottom: solid 1px; min-width: 200px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 50%; float: left;">
                        时间：<input type="text" name="data[lecture_time]" value="<?php echo $need ? ($need['lecture_time'] ? date('Y-m-d H:i:s',$need['lecture_time']) : '') : ($detail['lecture_time'] ? date('Y-m-d H:i:s',$detail['lecture_time']) : ''); ?>" class="inputdatetime" style="border: none; border-bottom: solid 1px; width: 130px;" > &#12288;&#12288;
                        时长：<input type="text" name="data[lecture_long]" value="{$need ? $need['lecture_long'] : $detail['lecture_long']}" style="border: none; border-bottom: solid 1px; width: 100px;" > &#12288;&#12288;
                        地点：<input type="text" name="data[lecture_addr]" value="{$need ? $need['lecture_addr'] : $detail['lecture_addr']}" style="border: none; border-bottom: solid 1px; width: 100px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 20%; float: left; margin-left: 20px;">
                        <input type="radio" name="data[is_need_leader]" value="1" <?php if ($need ? ($need['is_need_leader'] == 1) : ($detail['is_need_leader'] == 1)) echo "checked"; ?>> &#8194;是 &#12288;
                        <input type="radio" name="data[is_need_leader]" value="0" <?php if ($need ? ($need['is_need_leader'] == 0) : ($detail['is_need_leader'] == 0)) echo "checked"; ?>> &#8194;否
                    </div>
                    <div style="width: 60%; float: left;">
                        时间：<input type="text" class="inputdatetime" name="data[leader_time]" value="<?php echo $need ? ($need['leader_time'] ? date('Y-m-d H:i:s',$need['leader_time']) : '') : ($detail['leader_time'] ? date('Y-m-d H:i:s',$detail['leader_time']) : ''); ?>" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                        要求：<input type="text" name="data[leader_condition]" value="{$need ? $need['leader_condition'] : $detail['leader_condition']}" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 70%; float: left;">
                        人数：<input type="text" name="data[member]" value="{$need ? $need['member'] : $detail['member']}" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                        次数：<input type="text" name="data[num]" value="{$need ? $need['num'] : $detail['num']}" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                        费用：<input type="text" name="data[material_cost]" value="{$need ? $need['material_cost'] : $detail['material_cost']}" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                    </div>
                </div>

                <div class="form-group col-md-12">
                    <label>其他线路要求</label><input type="text" name="data[other_line_condition]"  value="{$need ? $need['other_line_condition'] : $detail['other_line_condition']}" class="form-control" />
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 70%; float: left;">
                        院所名称：<input type="text" name="data[institutes]" value="{$need ? $need['institutes'] : $detail['institutes']}" style="border: none; border-bottom: solid 1px; min-width: 200px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 70%; float: left;">
                        星级: <select name="data[star]"  style="border: none; border-bottom: solid 1px; width: 100px;">
                            <option value="0" <?php if ($need ? ($need['star']==0) : ($detail['star']==0)) echo 'selected'; ?>>==请选择==</option>
