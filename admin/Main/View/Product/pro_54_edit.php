        ...
        <div class="content">
            ...
            <form method="post" action="{:U('Product/public_save')}" name="myform" id="detailForm">
                ...
                <!--<div class="form-group col-md-4">
                    <label>研学目的地：</label><input type="text" name=""  value="<?php /*echo $provinces[$list[province]].' - '.$list['addr']; */?>" class="form-control inputdate"  required />
                </div>-->

                <div class="form-group col-md-4">
                    <label>研学时间：</label><input type="text" name="in_time"  value="<?php echo $detail['st_time'] ? date('Y-m-d',$detail['st_time']).' - '.date('Y-m-d',$detail['et_time']) : ''; ?>" class="form-control between_day"  required />
                </div>

                <!--<div class="form-group col-md-4">
                    <label>研学天数：</label>
                    <input type="text" class="form-control" name="" value="{$detail.day}" />
                </div>-->
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 70%; float: left;">
                        ...
                        要求：<input type="text" name="data[house_condition]" value="{$detail['house_condition']}" style="border: none; border-bottom: solid 1px; width: 140px;" > &#12288;&#12288;
                    </div>
                </div>
                ...
                <div class="form-group col-md-12" style="overflow: hidden;">
                    ...
                    <div style="width: 20%; float: left;">
                        <input type="radio" name="data[is_need_leaflet]" value="1" <?php if ($detail['is_need_leaflet'] == 1) echo "checked"; ?>> &#8194;是 &#12288;
                        <input type="radio" name="data[is_need_leaflet]" value="0" <?php if ($detail['is_need_leaflet'] == 0) echo "checked"; ?>> &#8194;否
                    </div>
                    <div style="width: 70%; float: left;">
                        数量：<input type="text" name="data[leaflet_num]" value="{$detail['leaflet_num']}" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                        要求：<input type="text" name="data[leaflet_condition]" value="{$detail['leaflet_condition']}" style="border: none; border-bottom: solid 1px; min-width: 160px;" > &#12288;&#12288;
                    </div>
                </div>
