    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <?php }elseif($tm == 'q'){ ?>
                    <div class="btn-group" id="catfont" style="padding-bottom:20px;">
                        <!--<a href="{:U('Manage/HR_cost',array('year'=>$year-1))}" class="btn btn-default" style="padding:8px 18px;">上一年</a>-->
                        <a href="{:U('Manage/HR_cost',array('year'=>$year,'quarter'=>1,'month'=>3,'tm'=>$tm))}" class="btn btn-default <?php if($quarter==1){echo 'btn-info';}?>">第一季度</a>
                        <a href="{:U('Manage/HR_cost',array('year'=>$year,'quarter'=>2,'month'=>6,'tm'=>$tm))}" class="btn btn-default <?php if($quarter==2){echo 'btn-info';}?>">第二季度</a>
                        <a href="{:U('Manage/HR_cost',array('year'=>$year,'quarter'=>3,'month'=>9,'tm'=>$tm))}" class="btn btn-default <?php if($quarter==3){echo 'btn-info';}?>">第三季度</a>
                        <a href="{:U('Manage/HR_cost',array('year'=>$year,'quarter'=>4,'month'=>12,'tm'=>$tm))}" class="btn btn-default <?php if($quarter==4){echo 'btn-info';}?>">第四季度</a>
                        <!--<a href="{:U('Manage/HR_cost',array('year'=>$year+1))}" class="btn btn-default">下一年</a>-->
                    </div>
                <?php } ?>
