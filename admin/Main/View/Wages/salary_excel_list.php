...
<!--                            'month'=> $count['datetime']-->
                            <a href="{:U('Wages/salary_excel_list',array('archives'=>0,'datetime'=>$datetime))}" class="btn <?php if(!$archives){ echo 'btn-info';}else{ echo 'btn-default';} ?>">所有</a>
                            <a href="{:U('Wages/salary_excel_list',array('archives'=>1,'datetime'=>$datetime))}" class="btn <?php if($archives==1){ echo 'btn-info';}else{ echo 'btn-default';} ?>">中心</a>
                            <a href="{:U('Wages/salary_excel_list',array('archives'=>2,'datetime'=>$datetime))}" class="btn <?php if($archives==2){ echo 'btn-info';}else{ echo 'btn-default';} ?>">科旅</a>
                            <a href="{:U('Wages/salary_excel_list',array('archives'=>3,'datetime'=>$datetime))}" class="btn <?php if($archives==3){ echo 'btn-info';}else{ echo 'btn-default';} ?>">科行</a>
                            <a href="{:U('Wages/salary_excel_list',array('archives'=>4,'datetime'=>$datetime))}" class="btn <?php if($archives==4){ echo 'btn-info';}else{ echo 'btn-default';} ?>">行管局</a>
                        </div>
...
<div id="searchtext">
    ...
    <form action="{:U('Wages/salary_excel_list')}" method="post" id="searchform">
