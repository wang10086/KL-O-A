<div class="page-title-box">
    ...
    <P class="page-title-breadcrumb">
        <?php if ($list['form_url']){ ?>
            <a href="{:U(''.$list[form_url].'',array('id'=>$list['id']))}" target="_blank" class="<?php if (ACTION_NAME == 'public_form'){ echo "menu-font-color"; } ?>">流程表单</a> &nbsp;
        <?php }else{ ?>
            <a href="{:U('Zprocess/public_form',array('id'=>$list['id']))}" class="<?php if (ACTION_NAME == 'public_form'){ echo "menu-font-color"; } ?>">流程表单</a> &nbsp;
        <?php } ?>
