                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                        ...
                                        <if condition="rolemenu(array('Finance/sign_add'))">
                                ...
                                <table class="table table-bordered dataTable fontmini" id="tablelist" style="margin-top:10px;">
                                    <tr role="row" class="orders" >
                                        <th class="sorting" width="80" data="o.id">ID</th>
                                        <th class="sorting" data="o.status">部门</th>
                                        <th class="sorting" data="o.project">签字详情</th>
                                        <th width="60" class="taskOptions">修改密码</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="taskOptions">
                                            <a href="javascript:;" title="修改密码" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <if condition="rolemenu(array('Finance/delsign'))">
                                        <td class="taskOptions">
                                        <button onClick="javascript:ConfirmDel('{:U('Op/delproAAA',array('id'=>$row['id']))}')" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></button>
                                        </td>
                                        </if>
                                    </tr>
                                    </foreach>					
