                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools pull-right">
                                        <if condition="rolemenu(array('Finance/timely_edit'))">
                                ...
                                <div class="box-body">
                                    <table class="table table-bordered dataTable fontmini" id="tablelist" style="margin-top:10px;">
                                        <tr role="row" class="orders" >
                                            ...
                                            <if condition="rolemenu(array('Finance/timely_del'))">
                                                <th width="60" class="taskOptions">编辑</th>
                                            </if>
                                        </tr>
                                        <foreach name="lists" key="k" item="v">
                                            <tr>
                                                ...
                                                <if condition="rolemenu(array('Finance/timely_del'))">
                                                <td class="taskOptions">
                                                    <a href="javascript:;" onclick="ConfirmDel(`<?php echo U('Finance/timely_del',array('id'=>$v['id'])); ?>`)" title="删除" class="btn btn-warning btn-smsm"><i class="fa fa-times"></i></a>
                                                </td>
                                                </if>
                                            </tr>
                                        </foreach>
...
<script>
    ...
    function edit_timely(id) {
        art.dialog.open('index.php?m=Main&c=Finance&a=timely_edit&id='+id,{
            lock:true,
            title: '配置财务及时率考核指标',
            width:800,
            height:400,
