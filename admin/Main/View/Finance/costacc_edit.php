...
<div class="box box-warning">
    ...
    <div class="box-body">
        ...
        <div class="form-group col-md-4">
            <label>建议最低报价：</label>
            <div style=" width:100%;">
                <span style="width:65%; float:left;"><input type="text" name="info[costacc_min_price]" value="{$costacc_res.costacc_min_price}" class="form-control" required /></span>
        ...
        <div class="form-group col-md-4">
            <label>建议最高报价：</label>
            <div style=" width:100%;">
                <span style="width:65%; float:left;"><input type="text" name="info[costacc_max_price]" value="{$costacc_res.costacc_max_price}"  class="form-control" required /></span>
