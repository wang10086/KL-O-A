<include file="Index:header2" />
                            ...
                            <div class="box">
                                ...
                                <table class="table table-bordered dataTable fontmini" id="tablelist" style="margin-top:10px;">
                                    <tr role="row" class="orders" >
                                        ...
                                        <if condition="rolemenu(array('Finance/settlement'))">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($row['huikuan']){ echo '&yen; '.$row['huikuan'];} ?></td>
                                        <td><?php if($row['hetong']){ echo '已签订';} ?></td>
                                        <td>{$row.create_user_name}</td>
                                        <td>{$row.budget_audit_status}</td>
                                        <if condition="rolemenu(array('Finance/settlement'))">
                                        <td class="taskOptions">
                                        <a href="{:U('Finance/settlement',array('opid'=>$row['op_id']))}" title="详情" class="btn btn-info btn-smsm"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        </if>
            ...
            <div id="searchtext">
                ...
                <input type="hidden" name="a" value="settlementlist">
