...
<div class="progress-box">
    ...
    <font color="green">{$baoxiao.bx_user}</font>
    <?php if ($audit_userinfo['zm_audit_username']){ ?>
        <?php if ($audit_userinfo['zm_audit_status'] == 1){ ?>
                <span class="progress-line-box-green ml10 mr10"></span> <font color="green">{$audit_userinfo.zm_audit_username}</font>
