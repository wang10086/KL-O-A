                ...
                <div class="form-group col-md-12">
                    <div class="form-group col-md-12" style="align: center;">
                        <table style="width: 100%; margin-top: 20px;">
                            ...
                            <tr>
                                <td class="td_con" colspan="2" style="text-align: left; min-width:230px; ">报销单编号：{$baoxiao['jkd_id']}</td>
                            ...
                            <tr>
                                ...
                                <td class="td_con td">借款时间：{$baoxiao['jk_time']|date='Y 年 m 月 d 日',###}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="4" class="td_con td">
                                    <div class="form-group col-md-12">
                                        <textarea class="form-control no-border-textarea" readonly>{$baoxiao.description}</textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4" class="td_con td">开户行名称：{$baoxiao.bank_name}</td>
                                <td colspan="2" class="td_con td">账号：{$baoxiao.card_num}</td>
                            </tr>

                            <tr>
                                <td colspan="4" class="td_con td">借款单位：{$baoxiao.department}</td>
                                <td colspan="2" class="td_con td">借款人签字：<img src="/{$baoxiao.jk_file}" height="50px" alt=""></td>
                            </tr>
